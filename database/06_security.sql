...
-- 2) Привілеї на рівні схеми (Коментовано)
...
-- SET DEFAULT ROLE r_admin      FOR 'u_admin'@'%';
-- SET DEFAULT ROLE r_pharmacist FOR 'u_pharm'@'%';
-- SET DEFAULT ROLE r_cashier    FOR 'u_cashier'@'%';
-- SET DEFAULT ROLE r_auditor    FOR 'u_auditor'@'%';
